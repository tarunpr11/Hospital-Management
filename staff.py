...
def searchForm():
    ...
    title = tk.Label(root, text='Search Staff', bg='white', fg='#57a1f8',
                     font=('Microsoft YaHei UI Light', 49, 'bold'))
    title.place(x=600, y=10)
    pid_label = tk.Label(root, text="SID:", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                         fg='#00a0da')
    ...
    btn1 = tk.Button(root, text='Search Staff', font=('Arial', 18), width=20, height=2, command=getDetails)
    btn1.place(x=600, y=600)

    root.mainloop()

def search(details,root):
    query = f"SELECT * FROM Staff WHERE SID = {details[0]} OR FirstName = '{details[1]}'"
...
def remove(pid,root):
    query = f"DELETE FROM Staff WHERE SID = {int(pid)}"
    cursor.execute(query)
    connection.commit()
    success = tk.Label(root, text="Staff Deleted Successfully", bg='white',
...
def removeForm():
    ...
    root = tk.Tk()
    root.config(bg='white')
    title = tk.Label(root, text='Delete Staff', bg='white', fg='#57a1f8',
                     font=('Microsoft YaHei UI Light', 49, 'bold'))
    title.place(x=600, y=10)
    pid_label = tk.Label(root, text="SID:", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                         fg='#00a0da')
    ...
    btn1 = tk.Button(root, text='Delete Staff', font=('Arial', 18), width=20, height=2, command=getDetails)
    btn1.place(x=600, y=600)
...
def updateForm():
    ...
    root = tk.Tk()
    root.config(bg='white')
    title = tk.Label(root, text='Update Staff', bg='white', fg='#57a1f8', font=('Microsoft YaHei UI Light', 49, 'bold'))
    title.place(x=600, y=10)
    pid_label = tk.Label(root, text="SID:", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                                fg='#00a0da')
    pid_label.place(x=100, y=150)
    ...
    btn1 = tk.Button(root, text='Update Staff', font=('Arial', 18), width=20, height=2, command=getDetails)
    btn1.place(x=600, y=600)

    root.mainloop()

def update(details,root):
    query = f"UPDATE Staff SET {details[1]} = '{details[2]}' WHERE SID = {int(details[0])}"
    cursor.execute(query)
    connection.commit()
    success = tk.Label(root, text="Staff Updated Successfully", bg='white',
                       font=('Microsoft YaHei UI Light', 24, 'bold'), fg='#00a0da')
    success.place(x=520, y=700)
...
def display_records(rows,second_frame,root):
    ...
    btn1 = tk.Label(buttonframe,text="SID",bg='#00a0da',fg='white',height=2,borderwidth=1, relief=tk.RAISED)
    ...
    btn4 = tk.Label(buttonframe, text="Designation",bg='#00a0da',fg='white',borderwidth=1, relief=tk.RAISED)
    btn4.grid(row=0, column=4, sticky="nsew")
    btn5 = tk.Label(buttonframe, text="Gender",bg='#00a0da',fg='white',borderwidth=1, relief=tk.RAISED)
    btn5.grid(row=0, column=5, sticky="nsew")
    btn6 = tk.Label(buttonframe, text="Salary",bg='#00a0da',fg='white',borderwidth=1, relief=tk.RAISED)
    btn6.grid(row=0, column=6, sticky="nsew")
    btn7 = tk.Label(buttonframe, text="Age",bg='#00a0da',fg='white',borderwidth=1, relief=tk.RAISED)
...
def insertDetails(details,root):
    query = f"INSERT INTO STAFF(FirstName,MiddleName,LastName,Designation,Gender,Salary,Age) VALUES('{details[0]}','{details[1]}','{details[2]}','{details[3]}','{details[4]}',{details[5]},{details[6]})"
    cursor.execute(query)
    connection.commit()
    success = tk.Label(root, text="Staff Added Successfully", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),fg='#00a0da')
    success.place(x=550,y=700)

def entryForm(root):
    details = []
    def getDetails():
        details = [first_name.get(),middle_name.get(),last_name.get(),gender.get(),dob.get(),bg.get(),address.get()]
    ...
    gender_label = tk.Label(root, text="Designation", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                                fg='#00a0da')
    ...
    dob_label = tk.Label(root, text="Gender (M/F):", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                                fg='#00a0da')
    dob_label.place(x=800, y=150)
    dob = tk.Entry(root, font=('Microsoft YaHei UI Light', 22, 'bold'), borderwidth=2)
    dob.place(x=1015, y=150)

    bg_label = tk.Label(root, text="Salary:", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                                fg='#00a0da')
    bg_label.place(x=800, y=250)
    bg = tk.Entry(root, font=('Microsoft YaHei UI Light', 22, 'bold'), borderwidth=2)
    bg.place(x=1015, y=250)

    address_label = tk.Label(root, text="Age:", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                                fg='#00a0da')
    ...
    btn1 = tk.Button(root, text='Add Staff', font=('Arial', 18), width=20, height=2, command=getDetails)
    btn1.place(x=600,y=600)

def AddStaff():
    root = tk.Tk()
    root.config(bg='white')
    title = tk.Label(root,text='Add Staff',bg='white',fg='#57a1f8',font=('Microsoft YaHei UI Light', 49, 'bold'))
    title.place(x=600,y=10)
    entryForm(root)
    root.mainloop()
...
def StaffPage():
    ...
    label = tk.Label(root, text='Staff', fg='#00a0da', bg='white',
                     font=('Arial', 39, 'bold'))
    ...
    tk.Label(root, image=mainpage_pic2, bg='white').place(x=185, y=210)

    buttonframe = tk.Frame(root, bg='white')
    buttonframe.columnconfigure(0, weight=1)

    btn1 = tk.Button(buttonframe, text='Add Staff', font=('Arial', 18), width=20,height=2,command=AddStaff)
    ...
    btn4 = tk.Button(buttonframe, text='Remove Staff', font=('Arial', 18), width=20,height=2,command=removeForm)
    btn4.grid(row=0, column=1, pady=15, padx=15)

    btn5 = tk.Button(buttonframe, text='Search Staff', font=('Arial', 18), width=20,height=2,command=searchForm)
