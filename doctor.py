...
def searchForm():
    ...
    title = tk.Label(root, text='Search Doctor', bg='white', fg='#57a1f8',
                     font=('Microsoft YaHei UI Light', 49, 'bold'))
    title.place(x=600, y=10)
    pid_label = tk.Label(root, text="DocID:", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                         fg='#00a0da')
    ...
    btn1 = tk.Button(root, text='Search Doctor', font=('Arial', 18), width=20, height=2, command=getDetails)
    btn1.place(x=600, y=600)

    root.mainloop()

def search(details,root):
    query = f"SELECT * FROM DOCTOR WHERE DocID = {details[0]} OR FirstName = '{details[1]}'"
...
def remove(pid,root):
    query = f"DELETE FROM DOCTOR WHERE DocID = {int(pid)}"
    cursor.execute(query)
    connection.commit()
    success = tk.Label(root, text="Doctor Deleted Successfully", bg='white',
...
def removeForm():
    ...
    root = tk.Tk()
    root.config(bg='white')
    title = tk.Label(root, text='Delete Doctor', bg='white', fg='#57a1f8',
                     font=('Microsoft YaHei UI Light', 49, 'bold'))
    title.place(x=600, y=10)
    pid_label = tk.Label(root, text="DocID:", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                         fg='#00a0da')
    ...
    btn1 = tk.Button(root, text='Delete Doctor', font=('Arial', 18), width=20, height=2, command=getDetails)
    btn1.place(x=600, y=600)
...
def updateForm():
    ...
    root = tk.Tk()
    root.config(bg='white')
    title = tk.Label(root, text='Update Doctor', bg='white', fg='#57a1f8', font=('Microsoft YaHei UI Light', 49, 'bold'))
    title.place(x=600, y=10)
    pid_label = tk.Label(root, text="DocID:", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                                fg='#00a0da')
    pid_label.place(x=100, y=150)
    ...
    btn1 = tk.Button(root, text='Update Doctor', font=('Arial', 18), width=20, height=2, command=getDetails)
    btn1.place(x=600, y=600)

    root.mainloop()

def update(details,root):
    query = f"UPDATE DOCTOR SET {details[1]} = '{details[2]}' WHERE DocID = {int(details[0])}"
    cursor.execute(query)
    connection.commit()
    success = tk.Label(root, text="Doctor Updated Successfully", bg='white',
                       font=('Microsoft YaHei UI Light', 24, 'bold'), fg='#00a0da')
    success.place(x=520, y=700)
...
def display_records(rows,second_frame,root):
    ...
    btn1 = tk.Label(buttonframe,text="DocID",bg='#00a0da',fg='white',height=2,borderwidth=1, relief=tk.RAISED)
    ...
    btn5 = tk.Label(buttonframe, text="Specialization",bg='#00a0da',fg='white',borderwidth=1, relief=tk.RAISED)
    btn5.grid(row=0, column=5, sticky="nsew")
    btn6 = tk.Label(buttonframe, text="Experience",bg='#00a0da',fg='white',borderwidth=1, relief=tk.RAISED)
...
def insertDetails(details,root):
    query = f"INSERT INTO DOCTOR(FirstName,MiddleName,LastName,Gender,Specialization,Experience,Age) VALUES('{details[0]}','{details[1]}','{details[2]}','{details[3]}','{details[4]}',{details[5]},{details[6]})"
    cursor.execute(query)
    connection.commit()
    success = tk.Label(root, text="Doctor Added Successfully", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),fg='#00a0da')
...
def entryForm(root):
    ...
    bg_label = tk.Label(root, text="Experience:", bg='white', font=('Microsoft YaHei UI Light', 24, 'bold'),
                                fg='#00a0da')
    ...
    btn1 = tk.Button(root, text='Add Doctor', font=('Arial', 18), width=20, height=2, command=getDetails)
    btn1.place(x=600,y=600)

def AddDoctor():
    root = tk.Tk()
    root.config(bg='white')
    title = tk.Label(root,text='Add Doctor',bg='white',fg='#57a1f8',font=('Microsoft YaHei UI Light', 49, 'bold'))
    title.place(x=600,y=10)
    entryForm(root)
    root.mainloop()
...
def DoctorPage():
    ...
    label = tk.Label(root, text='Doctor', fg='#00a0da', bg='white',
                     font=('Arial', 39, 'bold'))
    ...
    mainpage_pic2 = tk.PhotoImage(file=r'C:\Users\Tarun Parthiban\PycharmProjects\Hospital_Mgmt\doctor.png')
    tk.Label(root, image=mainpage_pic2, bg='white').place(x=135, y=150)

    buttonframe = tk.Frame(root, bg='white')
    buttonframe.columnconfigure(0, weight=1)
    buttonframe.columnconfigure(1, weight=1)

    btn1 = tk.Button(buttonframe, text='Add Doctor', font=('Arial', 18), width=20,height=2,command=AddDoctor)
    ...
    btn4 = tk.Button(buttonframe, text='Remove Doctor', font=('Arial', 18), width=20,height=2,command=removeForm)
    btn4.grid(row=0, column=1, pady=15, padx=15)

    btn5 = tk.Button(buttonframe, text='Search Doctor', font=('Arial', 18), width=20,height=2,command=searchForm)
